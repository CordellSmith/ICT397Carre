...
void Mesh::SetupMesh()
{
	...
	// vertex colours
	glVertexAttribPointer(0, 4, GL_FLOAT, GL_FALSE, sizeof(m_vertices[0]), (GLvoid*)sizeof(m_vertices[0].m_position));
	// vertex normals
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(m_vertices[0]), (GLvoid*)sizeof(m_vertices[0].m_colour));
	// vertex texture coords
	glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(m_vertices[0]), (GLvoid*)sizeof(m_vertices[0].m_normal));
...
void Mesh::Draw(Shader* shader)
{
	...
	shader->SetMatrix4(shader->GetVariable("model"), 1, false, &model[0][0]);
